...
const navigation = [
  ...
  { name: 'Extract', href: '/extract', current: false },
  { name: 'Dictionary', href: '/dictionary', current: false },
  { name: 'Thesaurus', href: '/thesaurus', current: false }
]
            ...
            <Menu as="div" className="relative ml-3">
              <div>
                <MenuButton className="relative flex rounded-full bg-gray-800 text-sm focus:outline-hidden">
                  ...
                  <img
                    alt=""
                    src="https://images.unsplash.com/photo-1735528655501-cf671a3323c3?q=80&w=580&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
